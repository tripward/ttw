<cfcomponent displayname="Departments" hint="I model a single Departments." extends="common.model.beans.baseBean" persistent="TRUE" accessors="true"  output="false">

	<cfproperty name="departmentID" fieldtype="id" generator="increment" />
	...
	<!---Relationships--->
	<cfproperty name="GovernmentTypes" fieldtype="many-to-one" lazy="true" cfc="GovernmentTypes" cascade="save-update" />
	<cfproperty name="DepartmentOrganizations" fieldtype="one-to-many" fkcolumn="departmentID" lazy="true" type="array" cfc="DepartmentOrganizations" cascade="save-update" singularname="DepartmentOrganization">
	
	
	<cfproperty name="contracts" fieldtype="many-to-many" CFC="accountManagement.model.beans.contracts" linktable="Contracts_To_Departments" FKColumn="departmentID" inversejoincolumn="contractID" lazy="true" cascade="save-update" orderby="contractID" singularname="contract">

	<cffunction name="getID" access="public" returntype="string" output="false">
		<cfreturn this.departmentID />
	</cffunction>
	...
	<cffunction name="displayListEntry" access="public" returntype="string" output="false">
		...
		<cfsavecontent variable="local.content">
			<cfoutput>
				<td><a href="#arguments.thePath#&id=#this.getDepartmentid()#">#this.getName()#</a></td>
	...
	<cffunction name="form" access="public" returntype="string" output="false">
		...
		<cfsavecontent variable="local.content">
			<cfoutput>
				...
				<input type="hidden" name="Departmentid" value="#this.getDepartmentid()#" />
