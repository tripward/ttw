<cfcomponent displayname="searchServices" extends="dataManagerServices" persistent="false" accessors="true" hint="" output="false">
	...
	<cfproperty name="objectType" type="string" default="GovernmentTypes" persistent="false" />
	<cfproperty name="idCol" type="string" default="GovernmentTypeid" persistent="false" />
	...
	<cffunction name="getByParameters" access="public" returntype="any">
		...
		<cftry>
		<cfset local.objs = EntityLoad(this.getObjectType(), {name="#arguments.info.governmentType#"}, false) />
