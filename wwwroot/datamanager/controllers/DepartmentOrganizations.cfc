<cfcomponent displayname="DepartmentOrganizations controller" hint="DepartmentOrganizations controller" extends="main" output="false" accessors="TRUE">

	<cffunction name="getMyServices" access="public" returntype="any">
		<cfreturn DepartmentOrganizationsServices />
	</cffunction>
